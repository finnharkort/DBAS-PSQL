...
INSERT INTO post(postID, userID, title, date, place) VALUES (1, 3, 'På stranden :) Vad gör ni?', '2024-06-24');
INSERT INTO videopost(postID, videoURL, codec) VALUES (1, 'https://vimeo.com/123456789', 'HEVC');

INSERT INTO post(postID, userID, title, date, place) VALUES (2, 1, NULL, '2024-08-01');
INSERT INTO imagePost(postID, imageURL, filter) VALUES (2, 'https://i.imgur.com/dQw4w9W.jpg', 'sepia');

INSERT INTO post(postID, userID, title, date, place) VALUES (3, 6, 'Pluggar...', '2024-10-15');
...
INSERT INTO attende(eventID, userID) VALUES (1,1);
INSERT INTO attende(eventID, userID) VALUES (1,2);
INSERT INTO attende(eventID, userID) VALUES (1,3);
INSERT INTO attende(eventID, userID) VALUES (1,6);
